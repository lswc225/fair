// Generated by Fair on 2021-12-10 10:48:51.381481.
import 'dart:async';
...
class AppGeneratedModule extends GeneratedModule {
  ...
  Map<String, dynamic> components() {
    return {
      ...
      'BottomNavyBar#onItemSelected': <int>(props) => (
            int value,
          ) {
            return (props['block']);
          },
      ...
      'SlidableDismissal#onResize': (props) => () {
            return (props['block']);
          },
      'SlidableDismissal#onDismissed': (props) => (
            SlideActionType actionType,
          ) {
            return (props['block']);
          },
      'SlidableDismissal#onWillDismiss': (props) => (
            SlideActionType actionType,
          ) {
            return (props['block']) as FutureOr;
          },
      ...
      'Slidable': (props) => Slidable(
            ...
            actionExtentRatio: props['actionExtentRatio']?.toDouble() ?? 0.25,
